...
namespace BibleView.Components
{
    public class ComboBoxCustom<T> : ComboBox
    {
        private readonly ListBox _suggLb = new ListBox { Visible = false, TabStop = false };
        private readonly BindingList<T> _suggBindingList = new BindingList<T>();
        private Expression<Func<ObjectCollection, IEnumerable<T>>> _propertySelector;
        private Func<ObjectCollection, IEnumerable<T>> _propertySelectorCompiled;
        private Expression<Func<T, string, bool>> _filterRule;
        private Func<T, bool> _filterRuleCompiled;
        private Expression<Func<T, string>> _suggestListOrderRule;
        private Func<T, string> _suggestListOrderRuleCompiled;
        ...
        /// </summary>
        public Expression<Func<ObjectCollection, IEnumerable<T>>> PropertySelector
        {
        ...
        ///</summary>
        public Expression<Func<T, string, bool>> FilterRule
        {
        ...
        ///</summary>
        public Expression<Func<T, string>> SuggestListOrderRule
        {
        ...
        {
            _filterRuleCompiled = s => s.ToString().ToLower().Contains(Text.Trim().ToLower());
            _suggestListOrderRuleCompiled = s => s.ToString();
            _propertySelectorCompiled = collection => collection.Cast<T>();
        ...
        public ComboBoxCustom(IContainer container)
        {
            container.Add(this);
        }
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            //{
            //    Text = _suggBindingList.FirstOrDefault();
